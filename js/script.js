const ApiKey = "4202fae1044245f7886851acc06b4a60";
                    ...
                    fetch(url, fetchHeader)
                        ...
                        .then(data => {
                            ...
                            <table class="responsive-table striped">
                                ...
                                <tr>
                                    <td>Team Name</td>
                                    <td>${(data.shortName == null) ? 'Empty' : data.shortName}</td>
                                </tr>
                                <tr>
                                    <td>Founded In</td>
                                    <td>${(data.founded == null) ? 'Empty' : data.founded}</td>
                                </tr>
                                <tr>
                                    <td>Venue</td>
                                    <td>${(data.venue == null) ? 'Empty' : data.venue}</td>
                                </tr>
                                <tr>
                                    <td>Address</td>
                                    <td>${(data.address == null) ? 'Empty' : data.address}</td>
                                </tr>
                                <tr>
                                    <td>Phone</td>
                                    <td>${(data.phone == null) ? 'Empty' : data.phone}</td>
                                </tr>
                                <tr>
                                    <td>Website</td>
                                    <td>${(data.website == null) ? 'Empty' : data.website}</td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td>${(data.email == null) ? 'Empty' : data.email}</td>
                                </tr>
                                <tr>
                                    <td>Club Color</td>
                                    <td>${(data.clubColors == null) ? 'Empty' : data.clubColors}</td>
                                </tr>
                                </tbody>
                            </table>`
